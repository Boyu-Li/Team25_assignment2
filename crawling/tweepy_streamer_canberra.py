...
class MyListener(StreamListener):
    ...
    def get_twitter_auth(self):
        ...
        '''
        try:
            consumer_key = "d62pUkVPmCn3Z7xqNMQMxWXMZ"
            consumer_secret = "XaxYpFE8Tg996xObHCEuinJSMzsOlgw6aURg0Q2pVPmVTCxJny"
            access_token = "929822293026410496-IEgodiHH2bp8811JQgVrYLf0YfIJD7j"
            access_secret = "LaExHPHyKbeOQ2uKECjryNOL1oi0IwiN0YS66BLGFRpwO"
        except KeyError:
    ...
    def on_data(self, data):
        try:
            with open('Canberra_twitter.json', 'a') as f:
                f.write(data)
                return True
...
twitter_stream.filter(locations=Canberra)